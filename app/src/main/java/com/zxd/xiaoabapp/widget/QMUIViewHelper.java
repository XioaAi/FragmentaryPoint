package com.zxd.xiaoabapp.widget;
...
public class QMUIViewHelper {
     ...
     */
    /*public static TranslateAnimation slideIn(final View view, int duration, final Animation.AnimationListener listener, boolean isNeedAnimation, QMUIDirection direction) {
        if (view == null) {
            return null;
        }
        if (isNeedAnimation) {
