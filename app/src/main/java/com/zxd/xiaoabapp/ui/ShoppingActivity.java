...
public class ShoppingActivity extends BaseActivity {
     ...
     * @param iv
     */
    private void addCart( ImageView iv,boolean... is) {
//      一、创造出执行动画的主题---imageview
        //代码new一个imageview，图片资源是上面的imageview的图片
        // (这个图片就是执行动画的图片，从开始位置出发，经过一个抛物线（贝塞尔曲线），移动到购物车里)
        final ImageView goods = new ImageView(ShoppingActivity.this);
...
//        四、计算中间动画的插值坐标（贝塞尔曲线）（其实就是用贝塞尔曲线来完成起终点的过程）
        ...
        ObjectAnimator scaleXAnimator=ObjectAnimator.ofFloat(goods, "scaleX", 1.0f , 0.5f );
        ObjectAnimator scaleYAnimator=ObjectAnimator.ofFloat(goods, "scaleY", 1.0f , 0.5f );

        ObjectAnimator alphaAnimator=ObjectAnimator.ofFloat(goods, "alpha", 1.0f,0.5f);

        ObjectAnimator rotateAnimator=ObjectAnimator.ofFloat(goods, "rotation", 360f,0f);
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                Log.i("Tag",value+"-"+mCurrentPosition[0]+"-"+mCurrentPosition[1]+"-"+startX+"-"+startY);
...
//      五、 开始执行动画
        ...
        goods.startAnimation(scaleAnimation);*/
